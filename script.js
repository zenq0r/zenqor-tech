...
const translations = {
    en: {
        ...
        hero_title: "Developing FiveM Scripts & Systems <br><span class='text-primary'>Websites & Cloud Solutions</span>",
        hero_sub: "Zenqor Technologies specializes in custom Lua scripting, framework-agnostic standalone resources, and server optimization for GTA V roleplay communities.",
    ...
    ms: {
        ...
        hero_title: "Membina Skrip & Sistem FiveM <br><span class='text-primary'>Website dan Sistem Cloud</span>",
        hero_sub: "Zenqor Technologies pakar dalam skrip Lua tersuai, sumber standalone bebas framework, dan pengoptimuman pelayan untuk komuniti 'roleplay' GTA V.",
        ...
        srv_2_t: "Sumber Standalone", srv_2_d: "Alatan bebas framework yang mudah disepadukan terus ke dalam mana-mana pelayan.",
        ...
        pw_hero_sub: "Konfigurasi penuh pelayan dan pembinaan seni bina sistem belakang.",
        pw_1_t: "Asas Pelayan QBCore", pw_1_d: "Sistem asas QBCore yang telah dikonfigurasi sepenuhnya dan sedia untuk 'roleplay' skala besar.",
        pw_2_t: "Peningkatan Prestasi ESX", pw_2_d: "Penulisan semula kod pelayan ESX lama untuk membaiki masa bacaan (ms) skrip dan kestabilan.",
        ...
        car_page_sub: "Bekerjasama dengan pengaturcara Lua dan pereka UI elit untuk membina masa hadapan pengalaman FiveM.",
        perk_1_t: "Kerja Jarak Jauh", perk_1_d: "Waktu kerja fleksibel dengan peluang bekerja dari rumah 100%.",
        perk_2_t: "Perkongsian Keuntungan", perk_2_d: "Raih peratusan daripada jualan skrip premium di kedai Tebex kami.",
        perk_3_t: "Pembangunan Kemahiran", perk_3_d: "Belajar selok-belok teknik pengoptimuman dan corak pengaturcaraan peringkat tinggi.",
        perk_4_t: "Alatan Moden", perk_4_d: "Bekerja dengan tetapan IDE terkini, kawalan versi, dan proses reka bentuk UI.",
        jobs_title: "Jawatan <span class='text-primary'>Kosong</span>",
        job_1_t: "Pengaturcara Lua Kanan", job_1_d: "Membangunkan skrip pihak pelayan dan pelanggan. Pengalaman mendalam tentang 'natives' FiveM diperlukan.",
        job_2_t: "Pembangun NUI / Muka Depan", job_2_d: "Mereka bentuk antara muka moden dalam permainan menggunakan React, Vue, atau Vanilla JS.",
        job_3_t: "Juruteknik Infrastruktur Pelayan", job_3_d: "Menguruskan pelayan VPS/Dedicated, persekitaran pangkalan data, dan sistem anti-cheat.",
        btn_apply: "Mohon melalui Discord/E-mel",
        con_title: "Mulakan <span class='text-primary'>Hubungan</span>",
        con_sub: "Bekerjasama dengan kami untuk membina ciri hebat pelayan anda yang seterusnya.",
