...
const translations = {
    en: {
        ...
        nav_srv_dev: "Development Services", nav_srv_lic: "Licensing & Permits",
        ...
        lic_main_title: "Corporate <span class='text-primary'>Licensing & Permits</span>",
        lic_main_sub: "Zenqor Technologies provides professional management for business licences, premise licences, signboard licences, and permit services to help individuals, companies, and organizations get local authority (PBT) approvals easily, quickly, and professionally.",
        lic_1_t: "Malaysia Business Licence", lic_1_d: "Comprehensive registration and compliance for your business in Malaysia.",
        lic_2_t: "Business Premise Licence", lic_2_d: "Fast-track your physical store or office premise licensing.",
        lic_3_t: "Signboard Licence", lic_3_d: "Authorized permits for your business signages and advertising boards.",
        lic_4_t: "Permit Services", lic_4_d: "General and specialized permits from relevant local authorities.",
        lic_5_t: "Licence Renewal", lic_5_d: "Hassle-free annual renewals for all your existing business licenses.",
        lic_6_t: "Documentation Support", lic_6_d: "Professional preparation of paperwork and official documentation.",
        lic_7_t: "Consultation Services", lic_7_d: "Expert advice on regulatory compliance and business setups.",
    ...
    ms: {
        ...
        nav_srv_dev: "Perkhidmatan Pembangunan", nav_srv_lic: "Lesen & Permit",
        ...
        lic_main_title: "Lesen Perniagaan & <span class='text-primary'>Permit</span>",
        lic_main_sub: "ZENQOR TECHNOLOGIES menyediakan perkhidmatan pengurusan lesen perniagaan, lesen premis, lesen papan tanda, permit serta penyediaan dokumentasi bagi membantu individu, syarikat dan organisasi mendapatkan kelulusan daripada pihak berkuasa tempatan (PBT) dengan lebih mudah, cepat dan profesional.",
        lic_1_t: "Malaysia Business Licence", lic_1_d: "Pendaftaran dan pematuhan lesen perniagaan yang komprehensif di Malaysia.",
        lic_2_t: "Business Premise Licence", lic_2_d: "Pengurusan lesen premis kedai atau pejabat fizikal anda dengan pantas.",
        lic_3_t: "Signboard Licence", lic_3_d: "Permit sah untuk papan tanda perniagaan dan papan iklan anda.",
        lic_4_t: "Permit Services", lic_4_d: "Permohonan permit umum dan khusus daripada pihak berkuasa tempatan.",
        lic_5_t: "Licence Renewal", lic_5_d: "Pembaharuan tahunan yang mudah untuk semua lesen perniagaan sedia ada anda.",
        lic_6_t: "Documentation Support", lic_6_d: "Penyediaan kertas kerja dan dokumentasi rasmi secara profesional.",
        lic_7_t: "Consultation Services", lic_7_d: "Khidmat nasihat pakar mengenai pematuhan peraturan dan persediaan perniagaan.",
